  ...
  return (
    ...
    <div class="min-h-screen flex flex-col items-center justify-center">
      <div class="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
        <div class="md:max-w-md w-full px-4 py-4">
          <form>
            <div class="mb-12">
              ...
              <p class="text-sm mt-4 text-gray-800">Don't have an account <a href="javascript:void(0);" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap"><Link to={'Register'}>Register here</Link></a></p>
            </div>
        ...
        <div class="">
          <img src={login} class="w-full aspect-[12/12] object-contain fill-none" alt="login-image" />
        </div>
      </div>
    </div>
  </div>
